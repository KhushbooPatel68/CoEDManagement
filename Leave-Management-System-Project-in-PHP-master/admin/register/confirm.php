...
if(!empty($errmsg))
...
else
	{
		...
		$pw = $uname;
		$sql = "INSERT INTO employees (UserName,EmpPass,EmpName,Dept,EarnLeave,SickLeave,CasualLeave,EmpEmail,DateOfJoin,Random,Designation,EmpType,EmpFee,DateOfBirth) VALUES "."('".$uname."','".$pw."','".$empname."','".$dept."','".$earnleave."','".$sickleave."','".$casualleave."','".$mailid."','".$doj."','1','".$designation."','".$emptype."','".$empfee."','".$dob."')";
